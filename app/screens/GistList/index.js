...
const selectors = {
    ...
    markdown: item =>
        item.files &&
        Object.keys(item.files).find(
            fileName => item.files[fileName].language === 'Markdown'
        ),
};
            ...
            >
                <TouchableOpacity
                    ...
                    onPress={() => {
                        ...
                        dispatch({
                            type: 'GIST_FETCH_REQUESTED',
                            payload: {gistId: item.id},
                        });
                    }}
                >
                    <Text style={styles.gistItemTitle}>{title}</Text>
        ...
        return (
            <GradientContainer>
                <View style={styles.header}>
                    ...
                    <Text style={styles.title}>My gists</Text>
                </View>
                {!gistsLoaded && (
                    <ActivityIndicator
